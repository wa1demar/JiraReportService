(function() {
    ...
    ProfileCtrl.$inject = ['$scope', '$routeParams', 'ProfileFactory', 'authenticationFactory', 'userAuthFactory', 'Notification'];

    function ProfileCtrl($scope, $routeParams, ProfileFactory, authenticationFactory, userAuthFactory, Notification) {
        var self = this;
