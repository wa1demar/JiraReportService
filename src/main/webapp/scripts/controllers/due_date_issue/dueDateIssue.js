(function() {
    ...
    angular
        ...
        .controller('DueDateIssueCtrl', DueDateIssueCtrl);

    DueDateIssueCtrl.$inject = ['$scope', 'DueDateIssueFactory', 'Notification'];

    function DueDateIssueCtrl($scope, DueDateIssueFactory, Notification) {
        var self = this;
