...
public class ApplicationMailerImpl implements ApplicationMailer {
    ...
    @Override
    public void sendMail(String to, String subject, Map properties, String velocity) throws MessagingException {
        ...
        String text_ = VelocityEngineUtils.mergeTemplateIntoString(velocityEngine, velocity + ".vm", properties);
